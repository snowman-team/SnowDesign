...
class IconActivity : AppCompatActivity() {
    ...
    private fun getAllIcon(): MutableList<IconModel> {
        ...
        list.add(IconModel(R.drawable.design_icon_award_question, "design_icon_award_question"))
        ...
        list.add(IconModel(R.drawable.design_icon_close_circle, "design_icon_close_circle"))
        list.add(IconModel(R.drawable.design_icon_collect, "design_icon_collect"))
        list.add(IconModel(R.drawable.design_icon_collected, "design_icon_collected"))
        ...
        list.add(IconModel(R.drawable.design_icon_leader_board, "design_icon_leader_board"))
        list.add(IconModel(R.drawable.design_icon_delete_circle, "design_icon_delete_circle"))
        ...
        list.add(IconModel(R.drawable.design_icon_fans_headline, "design_icon_fans_headline"))
        ...
        list.add(IconModel(R.drawable.design_icon_hot_push, "design_icon_hot_push"))
        ...
        list.add(IconModel(R.drawable.design_icon_stock, "design_icon_stock"))
        list.add(IconModel(R.drawable.design_icon_stock_circle, "design_icon_stock_circle"))
        ...
        list.add(IconModel(R.drawable.design_icon_privacy, "design_icon_privacy"))
        list.add(IconModel(R.drawable.design_icon_question, "design_icon_question"))
        list.add(IconModel(R.drawable.design_icon_fans_push, "design_icon_fans_push"))
        ...
        list.add(IconModel(R.drawable.design_icon_trade_setting, "design_icon_trade_setting"))
        ...
        list.add(IconModel(R.drawable.design_icon_nav_clear, "design_icon_nav_clear"))
