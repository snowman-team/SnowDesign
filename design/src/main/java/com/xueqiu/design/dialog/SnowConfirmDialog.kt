...
class SnowConfirmDialog private constructor(val context: Context?, val builder: Builder) {
    ...
    class Builder(context: Context) {
        ...
        var positiveAction: (view: SnowConfirmDialog) -> Unit = {}
            private set

        var negativeAction: (view: SnowConfirmDialog) -> Unit = {}
            private set
        ...
        var styleRes: Int = R.style.DesignSnowball_Dialog_Confirm
            private set
        ...
        fun withPositiveButton(text: String, action: (view: SnowConfirmDialog) -> Unit): Builder {
            this.positiveText = text
            this.positiveAction = action
            return this
        }

        fun withNegativeButton(text: String, action: (view: SnowConfirmDialog) -> Unit): Builder {
        ...
        fun build(): SnowConfirmDialog {
            return SnowConfirmDialog(mContextWeak?.get(), this)
        }
